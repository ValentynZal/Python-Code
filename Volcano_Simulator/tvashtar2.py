"""
run a quick computer simulation to check
it out. Copy and edit the tvashtar.py code to randomly fire particles at 25, 35, 45, 55,
and 65 degrees. Set self.color to WHITE for 45 degrees and GRAY for all other angles
"""
...
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
LT_GRAY2 = (180, 180, 180)
LT_GRAY1 = (160, 160, 160)
GRAY = (120, 120, 120)
DK_GRAY2 = (100, 100, 100)
DK_GRAY1 = (80, 80, 80)
...
class Particle(pg.sprite.Sprite):
    ...
    angles_colors = {25: DK_GRAY1, 35: DK_GRAY2, 45: WHITE, 55: LT_GRAY1, 65: LT_GRAY2}
    ...
    def __init__(self, screen, background):
        ...
        self.gas = 'SO2'
        #self.color = Particle.angles_colors[self.gas]
    ...
    def vector(self):
        ...
        orient = random.randrange(25, 65, 10)  # 90 is vertical
        radians = math.radians(orient)
        self.color = Particle.angles_colors[orient]
...
def main():
    ...
    angle_label = legend_font.render('White = 45 degrees', True, WHITE, BLACK)
